...
DATABASES = {
    'default': {
        ...
        'NAME': 'noi_test_development',                      # Or path to database file if using sqlite3.
        'USER': 'noi',                      # Not used with sqlite3.
        'PASSWORD': 'change08',                  # Not used with sqlite3.
...
STATICFILES_DIRS = (
    ...
    #'/Users/eschalon/Dropbox/Sites/noi_test/organizations/static'
)
...
SECRET_KEY = '^m)nhn85bu+t&e^rbv!+z0g7&r&e4u_4nd!$)+pq(l_l+0ra*w'
